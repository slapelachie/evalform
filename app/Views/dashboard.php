    ...
    <div class="container">
        ...
        <div class="container d-flex flex-row mb-4">
            <div class="row flex-nowrap overflow-auto">
                ...
                <?php
                $focused_surveys = array_slice($surveys, 0, 5);
                foreach ($focused_surveys as $survey): ?>
                    <div class="col pe-1 my-2">
                        <a href="<?= base_url(
                            'surveys/' . $survey['id'] . '/manage'
                        ) ?>" style="color: inherit; text-decoration: none;">
                            <div class="card" style="width: 10rem ; height: 14rem">
        ...
        <div class="row row-cols-2 text-center">
            <?php foreach ($insights as $insight): ?>
                <?php if (!empty($insight['link'])): ?>
                    ...
                    <?php endif; ?>
                    <div class="col-<?= $insight['size'] ?> pb-4">
                        <div class="bg-light d-flex flex-column align-items-center justify-content-center rounded border p-3" style="height: 10rem">
                            <h4><?= $insight['name'] ?></h4>
